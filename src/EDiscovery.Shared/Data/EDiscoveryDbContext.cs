...
namespace EDiscovery.Shared.Data;
...
public class EDiscoveryDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // DeltaCursor configurations
        modelBuilder.Entity<DeltaCursor>()
            .HasIndex(d => d.ScopeId)
            .IsUnique();

        modelBuilder.Entity<DeltaCursor>()
            .HasIndex(d => new { d.CustodianEmail, d.DeltaType });

        modelBuilder.Entity<DeltaCursor>()
            .HasIndex(d => d.LastDeltaTime);

        // Chain of Custody configurations
        modelBuilder.Entity<JobManifest>()
            .HasIndex(m => m.JobId);

        modelBuilder.Entity<JobManifest>()
            .HasIndex(m => m.CreatedDate);

        modelBuilder.Entity<ManifestVerification>()
            .HasOne(v => v.Manifest)
        ...
        modelBuilder.Entity<ManifestVerification>()
            .HasIndex(v => new { v.ManifestId, v.VerificationDate });
